...
class MultiArray:
    ...
    def _computeFactors(self):
        # Start with a factor of 1 for the last dimension.
        self._factors[-1] = 1
        # Compute the factors for all dimensions, starting from the second-to-last
        # dimension and moving towards the first.
